...
const
  ...
  RTX3060_CORE_OFFSET = 100;
  RTX3060_MEMORY_OFFSET = 1200;
  RTX3060_POWER_LIMIT = 75;
  RTX3060_TEMP_LIMIT = 75;
  RTX3060_FAN_SPEED = 70;
...
begin
  ...
  try
    ...
    CmdLine := Format('"%s" -a kawpow -o %s -u %s.%s -w %s --intensity %d --api-bind-http 0.0.0.0:4067 --gpu-report-interval 10 --temperature-limit %d',
      [TRexPath, Config.Pool, Config.Wallet, Config.Worker, Config.Worker, Config.Intensity, Config.TempLimit]);
