object RunExecute: TRunExecute
  ...
  object ButtonStartMining: TscGPButton
    Left = 8
    Top = 228
    Width = 120
    Height = 30
    ...
    TabOrder = 3
    TabStop = True
    OnClick = ButtonStartMiningClick
    Animation = True
    Badge.Color = clRed
    Badge.ColorAlpha = 255
    Badge.Font.Charset = DEFAULT_CHARSET
  ...
  object ButtonStopMining: TscGPButton
    Left = 134
    Top = 228
    Width = 120
    Height = 30
